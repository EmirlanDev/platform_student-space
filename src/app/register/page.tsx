...
export default function Register() {
  ...
  return (
    <div className="flex items-center justify-center flex-col gap-[23px] py-[120px]">
          ...
          >
            ...
            <defs>
              <pattern
                ...
                height="1"
              >
                <use xlinkHref="#image0_779_65" transform="scale(0.0078125)" />
              </pattern>
              <image
                id="image0_779_65"
                width="128"
          ...
          >
            ...
            <defs>
              <pattern
                ...
                height="1"
              >
                <use xlinkHref="#image0_779_68" transform="scale(0.0078125)" />
              </pattern>
              <image
                id="image0_779_68"
                width="128"
